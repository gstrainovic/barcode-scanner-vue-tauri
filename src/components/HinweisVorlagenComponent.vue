...
<template>
  <div v-if="userRole === 'Produktion' && barcode" class="flex flex-col">
    <div class="table-container">
      <DataTable
        :value="hinweisVorlagen" sort-field="strg" :sort-order="+1"
        :paginator="false"
        :rows="10"
      >
        <template #header>
        ...
        <Column field="titel" header="Titel" sortable style="width: 60%;font-size: 1.05rem;">
          <template #body="slotProps">
            <a
              href="javascript:void(0)" class="text-blue-500 hover:underline cursor-pointer"
        ...
        <Column field="strg" header="STRG +" sortable style="width: 40%;font-size: 1.05rem;" />
      </DataTable>
    </div>
  </div>
</template>
